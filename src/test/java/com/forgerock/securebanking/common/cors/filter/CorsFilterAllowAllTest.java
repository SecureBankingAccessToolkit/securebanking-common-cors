...
@ActiveProfiles("allowall")
public class CorsFilterAllowAllTest {

    private static final String ORIGIN_DOMAIN = "https://bypassdomain.com";

    @Autowired
    private CorsFilter corsFilter;

    @Test
    public void when_bypass_allowedAll() throws ServletException, IOException {
